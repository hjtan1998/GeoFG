...
from .transformer_encoder_with_pair_ini import TransformerEncoderWithPair
...
class UniMolModelBase(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, dictionary):
        ...
        print("args.masked_token_loss: ", args.masked_token_loss)
    ...
    def forward(
        ...
        **kwargs
        ...
        # print("graph_attn_bias shape: ", graph_attn_bias.shape)   # torch.Size([256, 120, 120])
        # print("padding_mask shape: ", padding_mask.shape)   # torch.Size([4, 120])
        # print("x shape: ", x.shape)   # torch.Size([4, 120, 512])
        (
            encoder_rep,
            encoder_pair_rep,
        ...
        # print("encoder_pair_rep shape: ", encoder_pair_rep.shape)
        # print("delta_encoder_pair_rep shape: ", delta_encoder_pair_rep.shape)
        # print("x_norm shape: ", x_norm.shape)
        # print("delta_encoder_pair_rep_norm shape: ", delta_encoder_pair_rep_norm.shape)
