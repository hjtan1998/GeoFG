...
class ConformerSampleDataset(BaseWrapperDataset):
    def __init__(self, dataset, seed, atoms, coordinates, func_groups, fg_atom):
    ...
    def __cached_item__(self, index: int, epoch: int):
        ...
        return {"atoms": atoms, "coordinates": coordinates.astype(np.float32), "smi": self.dataset[index]["smi"], "func_groups": func_groups, "fg_atom": fg_atom}
